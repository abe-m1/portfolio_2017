(function(module) {
    ...
    smoothScroll.$inject = ['$compile', '$document', '$log', '$timeout', '$window'];

    function smoothScroll($compile, $document, $log, $timeout, $window) {
    ...
    */
    ...
    module.directive('smoothScroll', smoothScroll);
